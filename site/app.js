const translations = {
  en: {
    ...
    "map.design": "Design Systems",
    "map.verify": "QA And Launch",
    ...
    "profiles.creative": "design and motion",
    "profiles.qa": "browser and security",
    "profiles.deploy": "launch targets",
    "copy.short": "Copy",
  ...
  zh: {
    ...
    "profiles.creative": "设计和动效",
    "profiles.qa": "浏览器和安全",
    "profiles.deploy": "部署目标",
    "copy.short": "复制",
    "docs.eyebrow": "中英文文档",
